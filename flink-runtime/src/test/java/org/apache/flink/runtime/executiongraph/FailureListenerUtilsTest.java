...
import org.apache.flink.runtime.failurelistener.CountingFailureListener;
...
/** Test for {@link CountingFailureListener} created by {@link FailureListenerUtils}. */
public class FailureListenerUtilsTest {

    @Test
    public void testLoadDefaultExceptionClassifier() {
        ...
        assertEquals(2, failureListeners.size());
        for (FailureListener failureListener : failureListeners) {
            assertTrue(
                    failureListener instanceof TypeFailureListener
                            || failureListener instanceof CountingFailureListener);
        }
    }
}
