...
import org.apache.flink.test.plugin.jar.failurelistener.TestFailureListenerFactory;
...
/** Test for {@link FailureListenerFactory}. */
public class FailureListenerPluginTest extends PluginTestBase {
    ...
    public void setup() throws Exception {
         ...
         * tmp/plugins-root/
         *          |-------------failure-listener/
         *          |                            |-plugin-failure-listener-test-jar.jar
         * </pre>
         */
    ...
    @Test
    public void testPluginManagerLoadExceptionClassifier() {
        // Make sure our TestExceptionClassifier implementation is loaded
        ...
        Assert.assertEquals(
                TestFailureListenerFactory.class.getName(),
                serviceImplList.get(0).getClass().getName());
    }

    @Test
    public void testExceptionClassifierFactoryLoadPlugin() {
        // Make sure the default CountExceptionClassifier is included with default env configuration
        ...
        Assert.assertEquals(3, failureListeners.size());
    }
}
